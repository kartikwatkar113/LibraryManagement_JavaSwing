	...
	public Login() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				else if(checkStaffMember(textField.getText(),passwordField.getText())){
					setVisible(false);
		...
		// Assuming this code is inside the relevant method or constructor
		passwordField = new JPasswordField();
		passwordField.setFont(new Font("Arial", Font.PLAIN, 20));
		passwordField.setFocusTraversalKeysEnabled(false);

		// Set the border with a custom color and thickness (e.g., 2 pixels)
		...
		// Add the password field to the content pane or panel
